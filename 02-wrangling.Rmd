...
Here let's create a tibble containing the results of a uniform distribution. Suppose we wanted to simulate rolling a six sided dice 100 times. 

```{r}
fair_dice <- tibble(roll = runif(n = 100, min = 1, max = 6))

ggplot(data = fair_dice, aes(x = roll)) +
